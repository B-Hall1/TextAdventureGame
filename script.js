...
const q1 = `You are trying to carth a ghost called "Slimer" at the Sedgwick Hotel but have not seen him yet. Should you..
1. Take the elevator to look on the 12th floor
OR
2. Wair in the lobby to see if he shows up there
...
const gameOver2 = `It was the hotel maid and you nearly killed her. You are forced to leave the the hotel. ${gameOver}`;
